...
abstract class SingleCourseServices extends ChopperService {
  ...
  @Get(path: '${AppStrings.courseAsUnauthorized}/{id}')
  Future<Response<SingleCourseInfo>> getSingleCourseAsUnathorized(
    @Path('id') int id,
  );
  ...
  Future<Response<QuizResultResponse>> submitQuiz(@Body() QuizRequest body);
